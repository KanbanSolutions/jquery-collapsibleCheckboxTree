...
(function($) {
    "use strict";
    $.fn.collapsibleCheckboxTree = function(opt) {
        ...
        var defaults = {
            ...
            uuidToken : 'jqcct', // Append a unique string to the button ids
        ...
        this.each(function() {
            ...
            // Add button
            /* 
             * This is ugly, lets just use our own...
             * $(this).before('<button id="expand-' + options.uuidToken + '">Expand All</button>' +
             *                '<button id="collapse-' + options.uuidToken + '">Collapse All</button>' +
             *                '<button id="default-' + options.uuidToken + '">Default</button>');
             */
